      ...
      <div className='ContactBox'>
        ...
        <form className='ContactBox-form' action='' method='POST'>
          <div className='ContactBox-inputs'>
            ...
            <input className='ContactBox-input' type='email' name='email' id='email' placeholder='@email.com' required />
          </div>
          <div className='ContactBox-message'>
            <textarea className='ContactBox-textarea' name='message' id='message' minLength={20} maxLength={240} placeholder='¡Déjanos tu mensaje acá!' required />
          </div>
