const instagramPosts = [
  {
    ...
    imgAlt: 'Amar lo que haces. Hacer lo que amas. Cómo siempre, en mí segundo hogar',
  ...
  },
  {
    ...
    imgAlt: 'Deberíamos considerar como días perdidos aquellos en los que no hayamos bailado al menos una vez. - Friedrich Nietzsche',
    modifire: 'instagramPost'
  },
  {
    ...
    imgAlt: 'Ella es Araceli Río Gonzalez, a.k.a Spicy.',
    modifire: 'instagramPost'
  },
  {
    ...
    imgAlt: '🔥🔥No sé olviden que el 20/05 rompemos @casachicha.lp con mí amigo querido @ramisticoo haciendo una fusión increíble de nuestros artes🌶️🌈👽',
    modifire: 'instagramPost'
  },
  {
    ...
    imgAlt: 'Se viene un fin de año con FECHONES',
    modifire: 'instagramPost'
  },
  {
    ...
    imgAlt: 'Hermoso lo que se vivió anoche en @fungus.beer Gracias gracias gracias a todes lxs que fueron por bailarse todo y ponerle toda la onda!!!! Y gracias a @nikus.dv por la invitación. Viva el Psy 🎧❤️🌈',
    modifire: 'instagramPost'
  },
  {
    ...
    imgAlt: 'Gracias por bailarse todo y la buena onda de siempre ❤️🌈 Feliz día del DJ',
    modifire: 'instagramPost'
  },
  {
  ...
  },
  {
    ...
    imgAlt: 'Nochon de navidad. Nos bailamos todo!!! Gracias @maldito.pelado y @chopooo por la invitación. Son lo máximo ♥️',
    modifire: 'instagramPost'
  }
]
